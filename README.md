...
- `npm run dev`: Starts dev server with Hot Module Replacement on port 5173. Anytime a file changes, the changes will automatocally be reflected in the browser
